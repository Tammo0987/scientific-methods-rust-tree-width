...
For further context, our results can be compared to the Java study of Gustedt et al.~\cite{gustedt_2002}.
This comparison requires care: their analysis is source-level and structurally constrained, while ours is based on MIR basic-block CFGs.
