...
The Rust compiler lowers functions into the MIR after parsing and earlier compilation stages~\cite[Ch.~44]{rustc_dev_guide}.
The control-flow graph can be induced from the MIR: it consists of basic blocks containing simple typed statements, together with explicit control-flow transfers between those blocks.
